//0x1E0f284221E8DcB81c689ecD8F2EEc2e9F64bE51
...
contract LeDoge is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000 * 10**6 * 10**9; //1000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "LeDoge";
    string private _symbol = "LEDOGE";
    ...
    uint256 public _maxTxAmount = 1000000 * 10**6 * 10**9; //1% of _tTotal
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //Pancake Swap RouterV2 Mainnet
