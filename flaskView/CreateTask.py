...
def CreateTask():
    if request.method == 'POST':
        ...
        sql.execute("INSERT INTO Contarcts (ContractCode,Stayt,Mode,Priority)VALUES(?,?,?,?)",
                    (code, 0, mode, priority))
...
def Conect():
    ...
    app.route("/CreateTask", methods=["GET", "POST"])(CreateTask)
    app.route("/CreateTaskFiles", methods=["GET", "POST"])(CreateTaskFiles)
